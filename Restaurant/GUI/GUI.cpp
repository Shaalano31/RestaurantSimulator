...
void GUI::PrintMessage(string msg, string msg2, string msg3, string msg4, string msg5) const	//Prints a message on status bar
{
	...
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 1.5) + 5, msg2); // to be able to write multi-line
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 1.5) + 20, msg3);
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 1.5) + 35, msg4);
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 1.5) + 50, msg5);
}
//////////////////////////////////////////////////////////////////////////////////////////
